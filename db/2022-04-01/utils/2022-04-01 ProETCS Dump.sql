...
--
-- Host: 192.168.16.71    Database: etcsinfraiv22
-- ------------------------------------------------------
...
CREATE TABLE `associatedlocationentity` (
  `id_NetEntity` char(36) COLLATE utf8_czech_ci NOT NULL,
  ...
  `functionalLocationReference` varchar(32) COLLATE utf8_czech_ci DEFAULT NULL,
  `physicalLocationReference` varchar(32) COLLATE utf8_czech_ci DEFAULT NULL,
...
INSERT INTO `balise` VALUES ('0755058c-99ca-4a02-8f95-5e2ae1bcb75c','fixed','ffffffffffffffff'),('07be4875-623f-4b25-8e32-e79bbf929a08','fixed','ffffffffffffffff'),('0cdbbfb5-c081-4dc5-a2ba-734c8123170b','fixed','ffffffffffffffff'),('1985bab8-1465-4ac3-bfa5-800d7890028c','fixed','ffffffffffffffff'),('1e351385-524e-4fd5-b3e3-eab03383143f','fixed','ffffffffffffffff'),('1e81c9b2-c2f8-40e6-8bea-fd94fe3aeabf','fixed','ffffffffffffffff'),('1e9a5717-0aa3-479a-8969-57e3af52b542','fixed','ffffffffffffffff'),('26e05d9a-5f77-4fc8-bab2-9910b373c083','fixed','ffffffffffffffff'),('27f9d7c5-a439-47b4-9f38-1177586cbe19','fixed','ffffffffffffffff'),('2ae4be72-ebde-4fb3-8ac8-e743dc8e0918','fixed','ffffffffffffffff'),('364e6b35-3705-4390-8bd7-9c4c069540a9','fixed','ffffffffffffffff'),('38069531-1026-4b46-a572-b128c18ec18c','fixed','ffffffffffffffff'),('3ad1de23-c02e-41e1-bec6-c625933d14e9','fixed','ffffffffffffffff'),('47529a09-a1cc-4ebf-8955-a16c39303eae','fixed','ffffffffffffffff'),('4b096cf3-4b8f-4075-b049-33927c60cc0d','fixed','ffffffffffffffff'),('4db19623-8331-4c81-9b7c-e8aebc03033b','fixed','ffffffffffffffff'),('4e0848bd-e5b3-4b67-bcc7-d0eaa666bfd0','fixed','ffffffffffffffff'),('50b05f70-ca53-4964-9a79-37222d7b275d','fixed','ffffffffffffffff'),('588b9192-e349-4031-bd8e-49dc16f19ff9','fixed','ffffffffffffffff'),('667477b7-e08a-4abe-906e-86bebc26b3bb','fixed','ffffffffffffffff'),('767b79cf-a053-4a00-b820-d093d68fd8b6','fixed','ffffffffffffffff'),('7949c5ca-400b-48cc-88ed-ced6c24a63b5','fixed','ffffffffffffffff'),('7c4accd2-c038-4d5e-a7f9-40daf277b9f8','fixed','ffffffffffffffff'),('7e1a4ce7-0234-457e-b3c2-caea25bbc39e','fixed','ffffffffffffffff'),('80147fbc-876f-43ae-8df5-fa3d3be8ecc5','fixed','ffffffffffffffff'),('8102be24-f1cc-4eb6-a8cb-9b4d8cdc559d','fixed','ffffffffffffffff'),('852f242d-cca6-4f21-b84b-9b9467ec7c65','fixed','ffffffffffffffff'),('887075e1-e3f7-4e5a-bea9-6f8ff03f6abb','fixed','ffffffffffffffff'),('8b7dcd59-82a0-4f3f-b91c-276b96f8dd0d','fixed','ffffffffffffffff'),('8e1f35a9-aab3-449e-8f30-a08e1174ae17','fixed','ffffffffffffffff'),('8e41fcbf-aeae-4c9d-acc6-1e65f52ca7ca','fixed','ffffffffffffffff'),('902dcdf8-7eb9-4444-af86-33193215bd88','fixed','ffffffffffffffff'),('9da483cb-9261-4fce-9b03-38d802585935','fixed','ffffffffffffffff'),('a516a241-330e-4da9-bb2f-9ddcb0a8a617','fixed','ffffffffffffffff'),('a7e51ff3-0c30-4d95-86ca-e2998a41d014','fixed','ffffffffffffffff'),('a9ad6b1b-5e11-4864-bc8b-794cc5d5df0f','fixed','ffffffffffffffff'),('b384513c-6bf6-4591-ba8f-3161ae1bba4c','fixed','ffffffffffffffff'),('b797f47e-a543-4bf4-979a-4083aba0000b','fixed','ffffffffffffffff'),('c2e508ab-139c-4601-84fe-6e534344ce92','fixed','ffffffffffffffff'),('dad6ecbd-73e0-40ad-9fa4-4c61339f57be','fixed','ffffffffffffffff'),('db5ffd82-7cc3-4969-a5a2-3171f46b120c','fixed','ffffffffffffffff'),('e7e87dcd-3043-4c7a-ad8f-8d00fa537498','fixed','ffffffffffffffff'),('eab7199d-6752-4d03-bf26-09241d91aa4c','fixed','ffffffffffffffff'),('f666ade4-0a4f-4c21-ba00-f7bf2860c1b1','fixed','ffffffffffffffff');
...
CREATE TABLE `geopointassociatedposition` (
  `id_AssociatedPosition` char(36) COLLATE utf8_czech_ci NOT NULL,
...
CREATE TABLE `levelnetwork` (
  ...
  `dimension` varchar(4) COLLATE utf8_czech_ci NOT NULL,
...
CREATE TABLE `netentityrelation` (
  `id` char(36) COLLATE utf8_czech_ci NOT NULL,
  `id_NetEntity_A` char(36) COLLATE utf8_czech_ci NOT NULL,
  `id_NetEntity_B` char(36) COLLATE utf8_czech_ci NOT NULL,
  `relationType` varchar(32) COLLATE utf8_czech_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping routines for database 'etcsinfraiv22'
--
...
-- Dump completed on 2022-04-01 12:48:06
