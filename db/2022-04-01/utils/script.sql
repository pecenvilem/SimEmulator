...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedLocationEntity` (
  ...
  INDEX `SI÷id_ENetEt×LALcEt` (`id_NetEntity` ASC) ,
  INDEX `SI÷id_LAsLoc×LALcEt` (`id_AssociatedLocation` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedPositionAssignment` (
  ...
  INDEX `SI÷id_LAssPsA×LAsPsA` (`id_AssociatedPosition_A` ASC) ,
  INDEX `SI÷id_LAssPsB×LAsPsA` (`id_AssociatedPosition_B` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedSection` (
  ...
  INDEX `FK÷id_LAssPsA×LAssSc_idx` (`id_AssociatedPosition_A` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`EntityOrientation` (
  ...
  INDEX `SI÷id_PPoSys×PEtOri` (`id_PositioningSystem` ASC) ,
  INDEX `SI÷id_ENetEt×PEtOri` (`id_NetEntity` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeoLocationEntity` (
  ...
  INDEX `SI÷id_LGeLoc×LGLcEt` (`id_GeoLocation` ASC) ,
  INDEX `SI÷id_ENetEt×LGLcEt` (`id_NetEntity` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeoPointAssociatedPosition` (
  ...
  INDEX `SI÷id_LAssPs×LGPAPs` (`id_AssociatedPosition` ASC) ,
  PRIMARY KEY (`id_AssociatedPosition`, `id_GeoPoint`),
  INDEX `SI÷id_LGeoPt×LGPAPs` (`id_GeoPoint` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`NetEntityRelation` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_ENetEtA×ENtEtA` (`id_NetEntity_A` ASC) ,
  INDEX `FK÷id_ENetEtB×ENtEtA_idx` (`id_NetEntity_B` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`PositionedRelation` (
  ...
  INDEX `FK÷id_TPNtElA×TPosRt_idx` (`id_PositioningNetElement_A` ASC) ,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`PositioningSystemNetElement` (
  ...
  INDEX `SI÷id_PPoSys×PPSNEl` (`id_PositioningSystem` ASC) ,
  INDEX `SI÷id_TPNtEl×PPSNEl` (`id_PositioningNetElement` ASC) ,
