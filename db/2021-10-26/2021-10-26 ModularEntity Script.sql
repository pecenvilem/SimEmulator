...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedPositioningSystem` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_PPoSys×PAssPS` (`id_PositioningSystem` ASC) VISIBLE,
  INDEX `SI÷id_TPNtEl×PAssPS` (`id_PositioningNetElement` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`DerivedNetEntity` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_ENetEtTemplate×EDerEt` (`id_NetEntity_Template` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`EntityLocationAssignment` (
  ...
  INDEX `SI÷id_ELocNE×EELocA` (`id_LocatedNetEntity` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeoFeatureAssociatedFeature` (
  ...
  INDEX `SI÷id_LAssFt×LGFAFt` (`id_AssociatedFeature` ASC) VISIBLE,
  INDEX `SI÷id_LGeoFt×LGFAFt` (`id_GeoFeature` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeoLocationOrientation` (
  ...
  INDEX `SI÷id_LGeLoc×PGLcOr` (`id_GeoLocation` ASC) VISIBLE,
  INDEX `SI÷id_PPoSys×PGLcOr` (`id_PositioningSystem` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`LocatedNetEntity` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_LEtLocPrimary×ELocNE` (`id_EntityLocation_Primary` ASC) VISIBLE,
