...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedFeature` (
  `id` CHAR(36) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK÷id_BNmRes×PAssFt`
    FOREIGN KEY (`id`)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`AssociatedPoint`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedPoint` (
  `id` CHAR(36) NOT NULL,
...
-- -----------------------------------------------------
-- Table `InfraDB`.`AssociatedPointGeoCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedPointGeoCoord` (
  `id_AssociatedPoint` CHAR(36) NOT NULL,
  `id_GeometricPositioningSystem` CHAR(36) NOT NULL,
  `sequence` INT NOT NULL,
  `x` DOUBLE NULL,
  `y` DOUBLE NULL,
  `z` DOUBLE NULL,
  INDEX `SI÷id_PGeoPS×PAPtGC` (`id_GeometricPositioningSystem` ASC),
  PRIMARY KEY (`id_AssociatedPoint`, `id_GeometricPositioningSystem`, `sequence`),
  INDEX `SI÷id_PAssPt×PAPtGC` (`id_AssociatedPoint` ASC),
  CONSTRAINT `FK÷id_PGeoPS×PAPtGC`
    FOREIGN KEY (`id_GeometricPositioningSystem`)
    REFERENCES `InfraDB`.`GeometricPositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_PAssPt×PAPtGC`
    FOREIGN KEY (`id_AssociatedPoint`)
    REFERENCES `InfraDB`.`AssociatedPoint` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `InfraDB`.`AssociatedPointLinearCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedPointLinearCoord` (
  `id_AssociatedPoint` CHAR(36) NOT NULL,
  ...
  INDEX `SI÷id_PLinPS×PAPtLC` (`id_LinearPositioningSystem` ASC),
  PRIMARY KEY (`id_AssociatedPoint`, `id_LinearPositioningSystem`, `sequence`),
  INDEX `SI÷id_PAssPt×PAPtLC` (`id_AssociatedPoint` ASC),
  CONSTRAINT `FK÷id_PLinPS×PAPtLC`
    FOREIGN KEY (`id_LinearPositioningSystem`)
    REFERENCES `InfraDB`.`LinearPositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_PAssPt×PAPtLC`
    FOREIGN KEY (`id_AssociatedPoint`)
    REFERENCES `InfraDB`.`AssociatedPoint` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`AssociatedSegment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedSegment` (
  `id` CHAR(36) NOT NULL,
  `id_AssociatedPoint_A` CHAR(36) NOT NULL,
  `id_AssociatedPoint_B` CHAR(36) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `SI÷id_PAssPtA×PAssSg` (`id_AssociatedPoint_A` ASC),
  INDEX `SI÷id_PAssPtB×PAssSg` (`id_AssociatedPoint_B` ASC),
  CONSTRAINT `FK÷id_PAssFt×PAssSg`
    FOREIGN KEY (`id`)
    REFERENCES `InfraDB`.`AssociatedFeature` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_PAssPtA×PAssSg`
    FOREIGN KEY (`id_AssociatedPoint_A`)
    REFERENCES `InfraDB`.`AssociatedPoint` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_PAssPtB×PAssSg`
    FOREIGN KEY (`id_AssociatedPoint_B`)
    REFERENCES `InfraDB`.`AssociatedPoint` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`ElementPartCollection` (
  `id` CHAR(36) NOT NULL,
  `id_CompositionNetElement` CHAR(36) NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `InfraDB`.`FunctionalLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`FunctionalLocation` (
  `id` CHAR(36) NOT NULL,
  `functionalLocationType` VARCHAR(32) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `FK÷id_LEtLoc×LFcLoc`
    FOREIGN KEY (`id`)
    REFERENCES `InfraDB`.`EntityLocation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`GeometricPositioningSystem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeometricPositioningSystem` (
  `id` CHAR(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`LocatedNetEntity` (
  `id` CHAR(36) NOT NULL,
  `id_EntityLocation_Primary` CHAR(36) NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `InfraDB`.`LocationFeatureAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`LocationFeatureAssignment` (
  `id_AssociatedFeature` CHAR(36) NOT NULL,
  `id_FunctionalLocation` CHAR(36) NOT NULL,
  `sequence` INT NOT NULL,
  `keepsOrientation` CHAR(1) NOT NULL,
  PRIMARY KEY (`id_AssociatedFeature`, `id_FunctionalLocation`, `sequence`),
  INDEX `SI÷id_LFcLoc×LLocFA` (`id_FunctionalLocation` ASC),
  INDEX `SI÷id_PAssFt×LLocFA` (`id_AssociatedFeature` ASC),
  CONSTRAINT `FK÷id_LFcLoc×LLocFA`
    FOREIGN KEY (`id_FunctionalLocation`)
    REFERENCES `InfraDB`.`FunctionalLocation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_PAssFt×LLocFA`
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`NetEntity` (
  `id` CHAR(36) NOT NULL,
  `id_NetEntity_Template` CHAR(36) NULL,
  `derivationRule` VARCHAR(32) NULL,
  PRIMARY KEY (`id`),
  INDEX `SI÷id_ENetEtTemplate×ENetEt` (`id_NetEntity_Template` ASC),
  CONSTRAINT `FK÷id_NNtwRs×ENetEt`
    FOREIGN KEY (`id`)
    REFERENCES `InfraDB`.`NetworkResource` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_ENetEtTemplate×ENetEt`
...
-- -----------------------------------------------------
-- Table `InfraDB`.`ObjectProjectionCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`ObjectProjectionCoord` (
...
-- -----------------------------------------------------
-- Table `InfraDB`.`ObjectProjectionSymbolCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`ObjectProjectionSymbolCoord` (
  `id_ObjectProjectionSymbol` CHAR(36) NOT NULL,
  `id_ScreenPositioningSystem` CHAR(36) NOT NULL,
  `x` INT UNSIGNED NOT NULL,
  `y` INT UNSIGNED NOT NULL,
  ...
  INDEX `SI÷id_VScrPS×VObPSC` (`id_ScreenPositioningSystem` ASC),
  INDEX `SI÷id_VObjPS×VObPSC` (`id_ObjectProjectionSymbol` ASC),
  CONSTRAINT `FK÷id_VScrPS×VObPSC`
    FOREIGN KEY (`id_ScreenPositioningSystem`)
    REFERENCES `InfraDB`.`ScreenPositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_VObjPS×VObPSC`
    FOREIGN KEY (`id_ObjectProjectionSymbol`)
    REFERENCES `InfraDB`.`ObjectProjectionSymbol` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`OrderedElementAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`OrderedElementAssignment` (
  `id_NetElement` CHAR(36) NOT NULL,
  `id_OrderedCollection` CHAR(36) NOT NULL,
  `sequence` INT UNSIGNED NOT NULL,
  PRIMARY KEY (`id_NetElement`, `id_OrderedCollection`),
  INDEX `SI÷id_TOrCol×TOColA` (`id_OrderedCollection` ASC),
  UNIQUE INDEX `UI÷id_TOrCol·sequence×TOColA` (`sequence` ASC, `id_OrderedCollection` ASC),
  INDEX `SI÷id_TNetEl×TOColA` (`id_NetElement` ASC),
  CONSTRAINT `FK÷id_TNetEl×TOColA`
    FOREIGN KEY (`id_NetElement`)
    REFERENCES `InfraDB`.`NetElement` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_TOrCol×TOColA`
...
-- -----------------------------------------------------
-- Table `InfraDB`.`PhysicalLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`PhysicalLocation` (
  `id` CHAR(36) NOT NULL,
  `physicalLocationType` VARCHAR(32) NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `FK÷id_LEtLoc×LPhLoc`
    FOREIGN KEY (`id`)
    REFERENCES `InfraDB`.`EntityLocation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`PhysicalLocationGeoCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`PhysicalLocationGeoCoord` (
  `id_PhysicalLocation` CHAR(36) NOT NULL,
  `id_GeometricPositioningSystem` CHAR(36) NOT NULL,
  `sequence` INT NOT NULL,
  `x` DOUBLE NULL,
  `y` DOUBLE NULL,
  `z` DOUBLE NULL,
  INDEX `SI÷id_PGeoPS×PPhLGC` (`id_GeometricPositioningSystem` ASC),
  PRIMARY KEY (`id_PhysicalLocation`, `id_GeometricPositioningSystem`, `sequence`),
  INDEX `SI÷id_LPhLoc×PPhLGC` (`id_PhysicalLocation` ASC),
  CONSTRAINT `FK÷id_PGeoPS×PPhLGC`
    FOREIGN KEY (`id_GeometricPositioningSystem`)
    REFERENCES `InfraDB`.`GeometricPositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_LPhLoc×PPhLGC`
    FOREIGN KEY (`id_PhysicalLocation`)
    REFERENCES `InfraDB`.`PhysicalLocation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `InfraDB`.`PhysicalLocationLinearCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`PhysicalLocationLinearCoord` (
  `id_PhysicalLocation` CHAR(36) NOT NULL,
  `id_LinearPositioningSystem` CHAR(36) NOT NULL,
  `sequence` INT NOT NULL,
  `measure` DOUBLE NULL,
  `lateralOffset` DOUBLE NULL,
  `verticalOffset` DOUBLE NULL,
  INDEX `SI÷id_PLinPS×PPhLLC` (`id_LinearPositioningSystem` ASC),
  PRIMARY KEY (`id_PhysicalLocation`, `id_LinearPositioningSystem`, `sequence`),
  INDEX `SI÷id_LPhLoc×PPhLLC` (`id_PhysicalLocation` ASC),
  CONSTRAINT `FK÷id_PLinPS×PPhLLC`
    FOREIGN KEY (`id_LinearPositioningSystem`)
    REFERENCES `InfraDB`.`LinearPositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_LPhLoc×PPhLLC`
    FOREIGN KEY (`id_PhysicalLocation`)
    REFERENCES `InfraDB`.`PhysicalLocation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`Signal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`Signal` (
  `id` CHAR(36) NOT NULL,
  `id_SignalType` CHAR(36) NULL,
  `referencePointHeight` DOUBLE NULL,
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XYSigT×XCSign` (`id_SignalType` ASC),
  CONSTRAINT `FK÷id_XCConE×XCSign`
    FOREIGN KEY (`id`)
    REFERENCES `InfraDB`.`ControlEntity` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_XYSigT×XCSign`
    FOREIGN KEY (`id_SignalType`)
    REFERENCES `InfraDB`.`SignalType` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SignalLabelTypeAssignment` (
  ...
  INDEX `SI÷id_XCSign×XCSLTA` (`id_Signal` ASC),
  CONSTRAINT `FK÷id_XCSign×XCSLTA`
    FOREIGN KEY (`id_Signal`)
    REFERENCES `InfraDB`.`Signal` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SpeedSectionSignalAssignment` (
  ...
  INDEX `SI÷id_XCSign×XOSSSA` (`id_Signal` ASC),
  CONSTRAINT `FK÷id_XCSign×XOSSSA`
    FOREIGN KEY (`id_Signal`)
    REFERENCES `InfraDB`.`Signal` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SwitchMachine` (
  ...
  `id_Signal` CHAR(36) NULL,
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XCSign×XCSwMa` (`id_Signal` ASC),
  ...
  CONSTRAINT `FK÷id_XCConE×XCSwMa`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_XCSign×XCSwMa`
    FOREIGN KEY (`id_Signal`)
    REFERENCES `InfraDB`.`Signal` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `InfraDB`.`UnorderedElementAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`UnorderedElementAssignment` (
  `id_NetElement` CHAR(36) NOT NULL,
  `id_UnorderedCollection` CHAR(36) NOT NULL,
  PRIMARY KEY (`id_NetElement`, `id_UnorderedCollection`),
  INDEX `SI÷id_TUoCol×TUColA` (`id_UnorderedCollection` ASC),
  INDEX `SI÷id_TNetEl×TUColA` (`id_NetElement` ASC),
  CONSTRAINT `FK÷id_TNetEl×TUColA`
    FOREIGN KEY (`id_NetElement`)
    REFERENCES `InfraDB`.`NetElement` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_TUoCol×TUColA`
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_AssociatedPoint`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_AssociatedPoint` (`id` INT, `id_PositioningNetElement` INT, `intrinsicReference` INT, `deltaPosition` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_OrderedElementAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_OrderedElementAssignment` (`id_NetElement` INT, `id_OrderedCollection` INT, `sequence` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_UnorderedElementAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_UnorderedElementAssignment` (`id_NetElement` INT, `id_UnorderedCollection` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ObjectProjectionCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ObjectProjectionCoord` (`id_ObjectProjection` INT, `id_ScreenPositioningSystem` INT, `sequence` INT, `x` INT, `y` INT, `z` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ObjectProjectionSymbolCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ObjectProjectionSymbolCoord` (`id_ObjectProjectionSymbol` INT, `id_ScreenPositioningSystem` INT, `x` INT, `y` INT, `z` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_GeometricPositioningSystem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_GeometricPositioningSystem` (`id` INT, `crsDefinition` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_AssociatedPointLinearCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_AssociatedPointLinearCoord` (`id_AssociatedPoint` INT, `id_LinearPositioningSystem` INT, `sequence` INT, `measure` INT, `lateralOffset` INT, `verticalOffset` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_AssociatedPointGeoCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_AssociatedPointGeoCoord` (`id_AssociatedPoint` INT, `id_GeometricPositioningSystem` INT, `sequence` INT, `x` INT, `y` INT, `z` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_PhysicalLocationLinearCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_PhysicalLocationLinearCoord` (`id_PhysicalLocation` INT, `id_LinearPositioningSystem` INT, `sequence` INT, `measure` INT, `lateralOffset` INT, `verticalOffset` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_PhysicalLocationGeoCoord`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_PhysicalLocationGeoCoord` (`id_PhysicalLocation` INT, `id_GeometricPositioningSystem` INT, `sequence` INT, `x` INT, `y` INT, `z` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_AssociatedSegment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_AssociatedSegment` (`id` INT, `id_AssociatedPoint_A` INT, `id_AssociatedPoint_B` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_LocationFeatureAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_LocationFeatureAssignment` (`id_AssociatedFeature` INT, `id_FunctionalLocation` INT, `sequence` INT, `keepsOrientation` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_FunctionalLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_FunctionalLocation` (`id` INT, `functionalLocationType` INT, `applicationDirection` INT, `lateralSide` INT, `lateralDistance` INT, `verticalSide` INT, `verticalDistance` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_PhysicalLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_PhysicalLocation` (`id` INT, `physicalLocationType` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_EntityLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_EntityLocation` (`id` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_NetEntity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_NetEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ModularEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ElectrificationEntity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ElectrificationEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_PowerSource`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_PowerSource` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ElectrificationArea`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ElectrificationArea` (`id` INT, `id_PowerSource` INT, `contactLineType` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_TrainProtectionEntity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_TrainProtectionEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_BaliseGroup`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_BaliseGroup` (`id` INT, `applicationType` INT, `mileageDirection` INT, `coverage` INT, `numberOfBalisesInGroup` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Balise`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Balise` (`id` INT, `baliseType` INT, `defaultTelegram` INT, `id_BaliseGroup` INT, `positionInGroup` INT, `duplicate` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_TransmissionLoop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_TransmissionLoop` (`id` INT, `id_TransmitterBox` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_SignificantLoopPoint`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_SignificantLoopPoint` (`id` INT, `id_TransmissionLoop` INT, `loopPointType` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_TransmitterBox`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_TransmitterBox` (`id` INT, `protectionSystem` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_OperationalEntity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_OperationalEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_SpeedSection`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_SpeedSection` (`id` INT, `maxSpeed` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_SpeedProfile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_SpeedProfile` (`id` INT, `speedProfileType` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_StoppingPlace`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_StoppingPlace` (`id` INT, `trainRelation` INT, `wagonCount` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_PlatformEdge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_PlatformEdge` (`id` INT, `id_Platform` INT, `maximumTrainLength` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_PlatformStoppingPlace`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_PlatformStoppingPlace` (`id` INT, `id_PlatformEdge` INT, `trainRelation` INT, `wagonCount` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_OperationalArea` (`id` INT, `isStoppingPoint` INT, `isStation` INT, `isDepot` INT, `isJunction` INT, `isInterstationSection` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_TrainDetectionEntity`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_TrainDetectionEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_TrackCircuit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_TrackCircuit` (`id` INT, `id_OperationalArea` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ImpedanceTransformer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ImpedanceTransformer` (`id` INT, `impedanceTransformerType` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_InsulatedRailJoint`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_InsulatedRailJoint` (`id` INT, `id_TrackCircuit_A` INT, `id_TrackCircuit_B` INT, `id_ImpedanceTransformer` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ControlEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_SwitchMachine`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_SwitchMachine` (`id` INT, `id_Turnout` INT, `switchMachineRole` INT, `defaultState` INT, `id_Signal` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_StructuralEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_TrackBed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_TrackBed` (`id` INT, `trackBedType` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Tunnel`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Tunnel` (`id` INT, `numberOfTracks` INT, `liningMaterial` INT, `crossSectionShape` INT, `horizontalCrossSectionDimension` INT, `height` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_SuperstructureComponent`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_SuperstructureComponent` (`id` INT, `id_OperationalArea` INT, `operationalDesignator` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Turnout`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Turnout` (`id` INT, `turnoutType` INT, `technicalDesignator` INT, `id_OperationalArea` INT, `operationalDesignator` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Crossing`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Crossing` (`id` INT, `id_OperationalArea` INT, `operationalDesignator` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Track`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Track` (`id` INT, `id_OperationalArea` INT, `operationalDesignator` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Platform`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Platform` (`id` INT, `id_OperationalArea` INT, `width` INT, `platformType` INT, `operationalDesignator` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_RailwayRoute`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_RailwayRoute` (`id` INT, `railwayRouteType` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_GeometryEntity` (`id` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_HorizontalCurve`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_HorizontalCurve` (`id` INT, `azimuth0` INT, `deltaAzimuth` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_VerticalCurve`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_VerticalCurve` (`id` INT, `horizontalLength` INT, `elevation0` INT, `deltaElevation` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_StraightHC`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_StraightHC` (`id` INT, `horizontalLength` INT, `azimuth0` INT, `deltaAzimuth` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_CircularArcHC`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_CircularArcHC` (`id` INT, `radius` INT, `azimuth0` INT, `deltaAzimuth` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_CubicParabolaHC`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_CubicParabolaHC` (`id` INT, `radius0` INT, `radius1` INT, `azimuth0` INT, `deltaAzimuth` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ClothoidHC`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ClothoidHC` (`id` INT, `radius0` INT, `radius1` INT, `azimuth0` INT, `deltaAzimuth` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_StraightVC`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_StraightVC` (`id` INT, `horizontalLength` INT, `elevation0` INT, `deltaElevation` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ParabolaVC`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ParabolaVC` (`id` INT, `parabolaVertexRadius` INT, `horizontalLength` INT, `elevation0` INT, `deltaElevation` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_Superelevation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_Superelevation` (`id` INT, `anchoredAxisReference` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_ConstantSuperelevation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_ConstantSuperelevation` (`id` INT, `superelevation` INT, `anchoredAxisReference` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_LinearSuperelevationRamp`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_LinearSuperelevationRamp` (`id` INT, `superelevation` INT, `anchoredAxisReference` INT, `id_NetEntity_Template` INT, `derivationRule` INT, `name` INT, `longname` INT);
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_AssociatedPoint`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_AssociatedPoint`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_AssociatedPoint` AS
SELECT * FROM BaseObject
NATURAL JOIN NamedResource
NATURAL JOIN AssociatedFeature
NATURAL JOIN AssociatedPoint;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_OrderedElementAssignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_OrderedElementAssignment`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_OrderedElementAssignment` AS
SELECT * FROM OrderedElementAssignment;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_UnorderedElementAssignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_UnorderedElementAssignment`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_UnorderedElementAssignment` AS
SELECT * FROM UnorderedElementAssignment;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_ObjectProjectionCoord`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_ObjectProjectionCoord`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_ObjectProjectionCoord` AS
SELECT * FROM ObjectProjectionCoord;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_ObjectProjectionSymbolCoord`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_ObjectProjectionSymbolCoord`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_ObjectProjectionSymbolCoord` AS
SELECT * FROM ObjectProjectionSymbolCoord;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_GeometricPositioningSystem`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_GeometricPositioningSystem`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_GeometricPositioningSystem` AS
SELECT * FROM BaseObject
NATURAL JOIN NamedResource
NATURAL JOIN PositioningSystem
NATURAL JOIN GeometricPositioningSystem;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_AssociatedPointLinearCoord`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_AssociatedPointLinearCoord`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_AssociatedPointLinearCoord` AS
SELECT * FROM AssociatedPointLinearCoord;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_AssociatedPointGeoCoord`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_AssociatedPointGeoCoord`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_AssociatedPointGeoCoord` AS
SELECT * FROM AssociatedPointGeoCoord;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_PhysicalLocationLinearCoord`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_PhysicalLocationLinearCoord`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_PhysicalLocationLinearCoord` AS
SELECT * FROM PhysicalLocationLinearCoord;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_PhysicalLocationGeoCoord`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_PhysicalLocationGeoCoord`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_PhysicalLocationGeoCoord` AS
SELECT * FROM PhysicalLocationGeoCoord;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_AssociatedSegment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_AssociatedSegment`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_AssociatedSegment` AS
SELECT * FROM BaseObject
NATURAL JOIN NamedResource
NATURAL JOIN AssociatedFeature
NATURAL JOIN AssociatedSegment;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_LocationFeatureAssignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_LocationFeatureAssignment`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_LocationFeatureAssignment` AS
SELECT * FROM LocationFeatureAssignment;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_FunctionalLocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_FunctionalLocation`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_FunctionalLocation` AS
SELECT * FROM BaseObject
NATURAL JOIN EntityLocation
NATURAL JOIN FunctionalLocation;

-- -----------------------------------------------------
-- View `InfraDB`.`CV_PhysicalLocation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_PhysicalLocation`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_PhysicalLocation` AS
SELECT * FROM BaseObject
NATURAL JOIN EntityLocation
NATURAL JOIN PhysicalLocation;
