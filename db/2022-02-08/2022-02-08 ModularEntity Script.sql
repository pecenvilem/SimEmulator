...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedPositionAssignment` (
  `id_AssociatedPosition_0` CHAR(36) NOT NULL,
  `id_AssociatedPosition_1` CHAR(36) NOT NULL,
  PRIMARY KEY (`id_AssociatedPosition_0`, `id_AssociatedPosition_1`),
  INDEX `SI÷id_LAssPs0×LAsPsA` (`id_AssociatedPosition_0` ASC) VISIBLE,
  INDEX `SI÷id_LAssPs1×LAsPsA` (`id_AssociatedPosition_1` ASC) VISIBLE,
  CONSTRAINT `FK÷id_LAssPs0×LAsPsA`
    FOREIGN KEY (`id_AssociatedPosition_0`)
    REFERENCES `InfraDB`.`AssociatedPosition` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_LAssPs1×LAsPsA`
    FOREIGN KEY (`id_AssociatedPosition_1`)
    REFERENCES `InfraDB`.`AssociatedPosition` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`EntityOrientation` (
  ...
  PRIMARY KEY (`id_PositioningSystem`, `id_NetEntity`),
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeoPointGeoCoordinate` (
  ...
  PRIMARY KEY (`id_GeoPositioningSystem`, `id_GeoPoint`),
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`GeoPointLinearCoordinate` (
  ...
  PRIMARY KEY (`id_LinearPositioningSystem`, `id_GeoPoint`),
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`InsulatedRailJoint` (
  ...
  INDEX `FK÷id_XDTCirB×XDIsRJ_idx` (`id_TrackCircuit_B` ASC) VISIBLE,
  INDEX `FK÷id_XDTCirA×XDIsRJ_idx` (`id_TrackCircuit_A` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`ObjectProjectionSymbol` (
  `id` CHAR(36) NOT NULL,
  `externalIconRef` VARCHAR(256) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`TrackCircuit` (
  ...
  `id_OperationalArea` CHAR(36) NULL,
  PRIMARY KEY (`id`),
  INDEX `FK÷id_XOOpPt×XDTCir_idx` (`id_OperationalArea` ASC) VISIBLE,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_GeoPointLinearCoordinate` (`id_LinearPositioningSystem` INT, `id_GeoPoint` INT, `measure` INT, `lateralOffset` INT, `verticalOffset` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_GeoPointGeoCoordinate`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_GeoPointGeoCoordinate` (`id_GeoPositioningSystem` INT, `id_GeoPoint` INT, `x` INT, `y` INT, `z` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_EntityOrientation` (`id_PositioningSystem` INT, `id_NetEntity` INT, `deltaHorizontalRotation` INT, `deltaVerticalRotation` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_AssociatedPositionAssignment` (`id_AssociatedPosition_0` INT, `id_AssociatedPosition_1` INT);
