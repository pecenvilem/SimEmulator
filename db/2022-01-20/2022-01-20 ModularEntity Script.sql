...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedSection` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_LAssPsA×LAssSc` (`id_AssociatedPosition_A` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`AssociatedSignalType` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XYSigT×XYASiT` (`id_SignalType` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`Balise` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XPBaGr×XPBlse` (`id_BaliseGroup` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`ElectrificationArea` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XEPwSr×XEElAr` (`id_PowerSource` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`EntityLocation` (
  `id` CHAR(36) NOT NULL,
  `functionalRepresentationReference` VARCHAR(32) NULL,
  `physicalRepresentationReference` VARCHAR(32) NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`EntityLocationAssignment` (
  ...
  `isDetermining` CHAR(1) NULL,
  PRIMARY KEY (`id_EntityLocation`, `id_NetEntity`),
  INDEX `SI÷id_ENetEt×EELocA` (`id_NetEntity` ASC) VISIBLE,
  INDEX `SI÷id_LEtLoc×EELocA` (`id_EntityLocation` ASC) VISIBLE,
  CONSTRAINT `FK÷id_ENetEt×EELocA`
...
-- -----------------------------------------------------
-- Table `InfraDB`.`EntityLocationOrientation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`EntityLocationOrientation` (
  `id_EntityLocation` CHAR(36) NOT NULL,
  `id_PositioningSystem` CHAR(36) NOT NULL,
  `frameworkSpecifier` INT NOT NULL,
  `intrinsicSpecifier` INT NOT NULL,
  `azimuthAngle` DOUBLE NULL,
  `elevationAngle` DOUBLE NULL,
  PRIMARY KEY (`id_EntityLocation`, `id_PositioningSystem`, `frameworkSpecifier`, `intrinsicSpecifier`),
  INDEX `SI÷id_PPoSys×PEtLcO` (`id_PositioningSystem` ASC) VISIBLE,
  INDEX `SI÷id_LEtLoc×PEtLcO` (`id_EntityLocation` ASC) VISIBLE,
  CONSTRAINT `FK÷id_PPoSys×PEtLcO`
    FOREIGN KEY (`id_PositioningSystem`)
    REFERENCES `InfraDB`.`PositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_LEtLoc×PEtLcO`
    FOREIGN KEY (`id_EntityLocation`)
    REFERENCES `InfraDB`.`EntityLocation` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `InfraDB`.`FeatureFeatureAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`FeatureFeatureAssignment` (
  `id_LocalizationFeature_A` CHAR(36) NOT NULL,
  `id_LocalizationFeature_B` CHAR(36) NOT NULL,
  `roleOfA` VARCHAR(32) NULL,
  `roleOfB` VARCHAR(32) NULL,
  PRIMARY KEY (`id_LocalizationFeature_A`, `id_LocalizationFeature_B`),
  INDEX `SI÷id_LLocFtA×LFtFtA` (`id_LocalizationFeature_B` ASC) VISIBLE,
  INDEX `SI÷id_LLocFtB×LFtFtA` (`id_LocalizationFeature_A` ASC) VISIBLE,
  CONSTRAINT `FK÷id_LLocFtA×LFtFtA`
    FOREIGN KEY (`id_LocalizationFeature_A`)
    REFERENCES `InfraDB`.`LocalizationFeature` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_LLocFtB×LFtFtA`
    FOREIGN KEY (`id_LocalizationFeature_B`)
    REFERENCES `InfraDB`.`LocalizationFeature` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`InsulatedRailJoint` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XDTCirA×XDIsRJ` (`id_TrackCircuit_A` ASC) VISIBLE,
  INDEX `SI÷id_XDTCirB×XDIsRJ` (`id_TrackCircuit_B` ASC) VISIBLE,
  INDEX `SI÷id_XDITra×XDIsRJ` (`id_ImpedanceTransformer` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `InfraDB`.`NetElementPositioningSystem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`NetElementPositioningSystem` (
  `id_PositioningNetElement` CHAR(36) NOT NULL,
  `id_PositioningSystem` CHAR(36) NOT NULL,
  INDEX `SI÷id_PPoSys×PNElPS` (`id_PositioningSystem` ASC) VISIBLE,
  INDEX `SI÷id_TPNtEl×PNElPS` (`id_PositioningNetElement` ASC) VISIBLE,
  PRIMARY KEY (`id_PositioningNetElement`, `id_PositioningSystem`),
  CONSTRAINT `FK÷id_TPNtEl×PNElPS`
    FOREIGN KEY (`id_PositioningNetElement`)
    REFERENCES `InfraDB`.`PositioningNetElement` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `FK÷id_PPoSys×PNElPS`
    FOREIGN KEY (`id_PositioningSystem`)
    REFERENCES `InfraDB`.`PositioningSystem` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`ObjectProjection` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_VVisul×VObjPr` (`id_Visualization` ASC) VISIBLE,
  INDEX `SI÷id_BBaObj×VObjPr` (`id_BaseObject` ASC) VISIBLE,
  INDEX `SI÷id_VObjPS×VObjPr` (`id_ObjectProjectionSymbol` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`ObjectProjectionCoordinate` (
  ...
  INDEX `SI÷id_VScrPS×VObjPC` (`id_ScreenPositioningSystem` ASC) VISIBLE,
  INDEX `SI÷id_VObjPr×VObjPC` (`id_ObjectProjection` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`OperationalAreaSignalAssignment` (
  ...
  INDEX `SI÷id_XOOpAr×XOOASA` (`id_OperationalArea` ASC) VISIBLE,
  INDEX `SI÷id_XCSign×XOOASA` (`id_Signal` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`OrderedCollectionElement` (
  ...
  UNIQUE INDEX `UI÷id_TOrCol·sequence×TOColE` (`sequence` ASC, `id_OrderedCollection` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`Platform` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XOOpAr×XSPlat` (`id_OperationalArea` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`PlatformEdge` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XSPlat×XSPlEg` (`id_Platform` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`PlatformStoppingPlace` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XSPlEg×XOPlSP` (`id_PlatformEdge` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`PositionedRelation` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_TPNtElA×TPosRt` (`id_PositioningNetElement_A` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`RouteComponentAssignment` (
  ...
  INDEX `SI÷id_XORaRo×XORCoA` (`id_RailwayRoute` ASC) VISIBLE,
  INDEX `SI÷id_XSSuCo×XORCoA` (`id_SuperstructureComponent` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`RouteControlEntityAssignment` (
  ...
  INDEX `SI÷id_XORaRo×XORCEA` (`id_RailwayRoute` ASC) VISIBLE,
  INDEX `SI÷id_XCConE×XORCEA` (`id_ControlEntity` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`RouteCurveAssignment` (
  ...
  INDEX `SI÷id_XGHorC×XORCuA` (`id_HorizontalCurve` ASC) VISIBLE,
  INDEX `SI÷id_XORaRo×XORCuA` (`id_RailwayRoute` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SignalComponentTypeAssignment` (
  ...
  INDEX `SI÷id_XYSigT×XYSCTA` (`id_SignalType` ASC) VISIBLE,
  INDEX `SI÷id_XYSiCT×XYSCTA` (`id_SignalComponentType` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SignalLabelTypeAssignment` (
  ...
  INDEX `SI÷id_XYLabT×XCSLTA` (`id_LabelType` ASC) VISIBLE,
  INDEX `SI÷id_XCTSig×XCSLTA` (`id_Signal` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SignificantLoopPoint` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XPTmLp×XPSLpP` (`id_TransmissionLoop` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SpeedProfileSectionAssignment` (
  ...
  INDEX `SI÷id_XOSpSc×XOSPSA` (`id_SpeedSection` ASC) VISIBLE,
  INDEX `SI÷id_XOSpPf×XOSPSA` (`id_SpeedProfile` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SpeedSectionSignalAssignment` (
  ...
  INDEX `SI÷id_XOSpSc×XOSSSA` (`id_SpeedSection` ASC) VISIBLE,
  INDEX `SI÷id_XCTSig×XOSSSA` (`id_Signal` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SuperstructureComponent` (
  ...
  `operationalDesignator` VARCHAR(32) NULL,
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XOOpAr×XSSuCo` (`id_OperationalArea` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SwitchMachine` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XCTSig×XCSwMa` (`id_TracksideSignal` ASC) VISIBLE,
  INDEX `SI÷id_XCSwMa×XSTurn` (`id_Turnout` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SwitchMachineRelationAssignment` (
  ...
  INDEX `SI÷id_TPosRt×XCSMRA` (`id_PossitionedRelation` ASC) VISIBLE,
  INDEX `SI÷id_XCSwMa×XCSMRA` (`id_SwitchMachine` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`SymbolCoordinate` (
  ...
  INDEX `SI÷id_VScrPS×VSymCo` (`id_ScreenPositioningSystem` ASC) VISIBLE,
  INDEX `SI÷id_VObjPS×VSymCo` (`id_ObjectProjectionSymbol` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`TrackCircuit` (
  ...
  `id_OperationalArea` CHAR(36) NULL,
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XOOpAr×XDTCir` (`id_OperationalArea` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`TrackCircuitLoopAssignment` (
  ...
  INDEX `SI÷id_XPTmLp×XDTCLA` (`id_TransmissionLoop` ASC) VISIBLE,
  INDEX `SI÷id_XDTCir×XDTCLA` (`id_TrackCircuit` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `InfraDB`.`TransmissionLoop` (
  ...
  PRIMARY KEY (`id`),
  INDEX `SI÷id_XPTmLp×XPSLpP` (`id_TransmitterBox` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_EntityLocationOrientation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_EntityLocationOrientation` (`id_EntityLocation` INT, `id_PositioningSystem` INT, `frameworkSpecifier` INT, `intrinsicSpecifier` INT, `azimuthAngle` INT, `elevationAngle` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_NetElementPositioningSystem`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_NetElementPositioningSystem` (`id_PositioningNetElement` INT, `id_PositioningSystem` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_AssociatedLocation` (`id` INT, `associatedLocationType` INT, `applicationDirection` INT, `lateralSide` INT, `lateralDistance` INT, `verticalSide` INT, `verticalDistance` INT, `functionalRepresentationReference` INT, `physicalRepresentationReference` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_GeoLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_GeoLocation` (`id` INT, `geoLocationType` INT, `functionalRepresentationReference` INT, `physicalRepresentationReference` INT);

-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_EntityLocation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_EntityLocation` (`id` INT, `functionalRepresentationReference` INT, `physicalRepresentationReference` INT);
...
-- -----------------------------------------------------
-- Placeholder table for view `InfraDB`.`CV_FeatureFeatureAssignment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_FeatureFeatureAssignment` (`id_LocalizationFeature_A` INT, `id_LocalizationFeature_B` INT, `roleOfA` INT, `roleOfB` INT);
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `InfraDB`.`CV_EntityLocationAssignment` (`id_EntityLocation` INT, `id_NetEntity` INT, `isDetermining` INT);
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_EntityLocationOrientation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_EntityLocationOrientation`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_EntityLocationOrientation` AS
SELECT * FROM EntityLocationOrientation;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_NetElementPositioningSystem`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_NetElementPositioningSystem`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_NetElementPositioningSystem` AS
SELECT * FROM NetElementPositioningSystem;
...
-- -----------------------------------------------------
-- View `InfraDB`.`CV_FeatureFeatureAssignment`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `InfraDB`.`CV_FeatureFeatureAssignment`;
USE `InfraDB`;
CREATE  OR REPLACE VIEW `CV_FeatureFeatureAssignment` AS
SELECT * FROM FeatureFeatureAssignment;
